 ...
 * @returns {Account}
 */
export function accountFromMnemonic(mnemonic, account, change, address_index, passphrase) {
 ...
 * @returns {Uint8Array}
 */
export function signCall(seed, call, context) {
    const ptr0 = passArray8ToWasm0(seed, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function signCallFromMnemonic(mnemonic, call, context, account, change, address_index, passphrase) {
    const ptr0 = passStringToWasm0(mnemonic, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(call, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    ...
    const ret = wasm.signCallFromMnemonic(ptr0, len0, ptr1, len1, context, account, change, address_index, ptr2, len2);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
 ...
 * @returns {Uint8Array}
 */
export function signTransfer(seed, params) {
    const ptr0 = passArray8ToWasm0(seed, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function signTransferFromMnemonic(mnemonic, params, account, change, address_index, passphrase) {
    const ptr0 = passStringToWasm0(mnemonic, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    var ptr1 = isLikeNone(passphrase) ? 0 : passStringToWasm0(passphrase, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    const ret = wasm.signTransferFromMnemonic(ptr0, len0, params, account, change, address_index, ptr1, len1);
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v3 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('quantus_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
